...
namespace nsm {
    ...
    std::unordered_map<std::string, std::string> ShaderProgram::sSourceCache;
    std::map<u32, u32> ShaderProgram::sProgramCacheRefCounter;
    std::unordered_map<std::string, std::pair<u32, std::unordered_map<std::string, i32>>> ShaderProgram::sProgramCache;

    ShaderProgram::Shader::Shader(const std::string& path, const ShaderType type)
        : id(GL_NONE)
    {
    ...
    ShaderProgram::ShaderProgram(const std::string& vshPath, const std::string& fshPath)
        : mId(GL_NONE)
        , mUniformLocations()
    {
    ...
    ShaderProgram::ShaderProgram(const std::string& vshPath, const std::string& fshPath, const std::string& gshPath)
        : mId(GL_NONE)
        , mUniformLocations()
    {
        for (const auto& [identifier, program] : sProgramCache) {
    ...
    i32 ShaderProgram::getOptionalLocation(const std::string& name) const {
        auto location = mUniformLocations.find(name);
    ...
    u32 ShaderProgram::link(const Shader& vsh, const Shader& fsh, const Shader* gsh) {
    ...
    void ShaderProgram::setDouble(const std::string& name, const double value) const {
    ...
    void ShaderProgram::setBool(const i32 location, const bool value) const {
        glUniform1i(location, value);
    }

    void ShaderProgram::setInt(const i32 location, const int value) const {
        glUniform1i(location, value);
    }

    void ShaderProgram::setFloat(const i32 location, const float value) const {
        glUniform1f(location, value);
    }

    void ShaderProgram::setDouble(const i32 location, const double value) const {
        glUniform1d(location, value);
    }

    void ShaderProgram::setVec2(const i32 location, const glm::vec2& value) const {
        glUniform2f(location, value.x, value.y);
    }

    void ShaderProgram::setVec3(const i32 location, const glm::vec3& value) const {
        glUniform3f(location, value.x, value.y, value.z);
    }

    void ShaderProgram::setVec4(const i32 location, const glm::vec4& value) const {
        glUniform4f(location, value.x, value.y, value.z, value.w);
    }

    void ShaderProgram::setMat4(const i32 location, const glm::mat4& value) const {
        glUniformMatrix4fv(location, 1, false, glm::value_ptr(value));
    }

    void ShaderProgram::setOptionalBool(const std::string& name, const bool value) const {
    ...
    void ShaderProgram::setOptionalInt(const std::string& name, const int value) const {
        const i32 location = this->getOptionalLocation(name);
        if (location == -1)
            return;
    ...
    void ShaderProgram::setOptionalFloat(const std::string& name, const float value) const {
        const i32 location = this->getOptionalLocation(name);
        if (location == -1)
            return;
    ...
    void ShaderProgram::setOptionalDouble(const std::string& name, const double value) const {
        const i32 location = this->getOptionalLocation(name);
        if (location == -1)
            return;
    ...
    void ShaderProgram::setOptionalVec2(const std::string& name, const glm::vec2& value) const {
        const i32 location = this->getOptionalLocation(name);
        if (location == -1)
            return;
    ...
    void ShaderProgram::setOptionalVec3(const std::string& name, const glm::vec3& value) const {
        const i32 location = this->getOptionalLocation(name);
        if (location == -1)
            return;
    ...
    void ShaderProgram::setOptionalVec4(const std::string& name, const glm::vec4& value) const {
        const i32 location = this->getOptionalLocation(name);
        if (location == -1)
            return;
    ...
    void ShaderProgram::setOptionalMat4(const std::string& name, const glm::mat4& value) const {
        const i32 location = this->getOptionalLocation(name);
        if (location == -1)
            return;
